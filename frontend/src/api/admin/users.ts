 ...
 * @param type - Optional type filter (balance, affiliate_balance, token_incentive, admin_balance, concurrency, admin_concurrency, subscription)
 ...
 */
export type PlatformQuotaPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'leo' | 'openai_media' | 'video'
