export default {
  ...
  version: {
    ...
    forkReleaseReady: '当前仓库有可用更新',
    upstreamUpdateAvailable: '原仓库有新版本',
    upstreamSyncNoticeTitle: '原仓库版本尚未同步',
    upstreamForkVersionGap: '原仓库最新版本为 v{upstream}，当前仓库最新版本为 v{fork}。',
    upstreamForkUpdatePolicy: '请先合并原仓库代码并发布当前仓库版本，再执行应用内更新。',
    upstreamSyncRequiredHint: '应用内更新不会直接安装原仓库版本。',
    noForkReleaseReadyHint: '当前仓库暂无可直接安装的 Release。',
    branchUpdateAvailable: '当前仓库分支有更新',
    branchUpdateHint: '当前分支有新提交，请先合并或重新发布后再更新。',
    releaseNotes: '更新日志',
