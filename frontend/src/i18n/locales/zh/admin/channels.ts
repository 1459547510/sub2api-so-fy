export default {
    ...
    channels: {
      ...
      noGroupsSelected: '请为 {platform} 选择至少一个关联分组',
      emptyModelsInPricing: '{platform} 存在未填写模型的定价条目',
    ...
    riskControl: {
      ...
      cyberPolicyRevokeGroup: '命中后移除专属分组',
      cyberPolicyRevokeGroupHint: '普通用户命中 cyber_policy 后移除所选 OpenAI 专属分组权限；管理员始终豁免，不影响其他分组。选择关闭可停用。',
      cyberPolicyRevokeGroupDisabled: '关闭自动移除',
