export default {
    accounts: {
      ...
      openai: {
        cyberPolicyUserBlocking: '屏蔽有上游 CY 历史的用户',
        cyberPolicyUserBlockingDesc: "开启后，曾触发上游 cyber_policy 的用户不会调度到此账号。默认关闭，管理员、hjt13845049131{'@'}163.com 和 c8289463{'@'}outlook.com 不受影响。",
