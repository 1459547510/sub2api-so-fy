    ...
    apiDocs: {
      ...
      fields: {
        ...
        endFrameUrl: '独立尾帧绝对 HTTP(S) 地址，可与首帧同时提交，但不能与参考图混用。',
         ...
         guidancesPublic: '参考媒体对象；将上传接口返回的 media_url 放入 image_reference、video_reference_base 或 audio_reference。happy-horse-1.1 最多 9 张参考图，Seedance 最多 4 张；视频最多 3 个，音频最多 1 个；参考音频必须搭配参考图或参考视频。',
