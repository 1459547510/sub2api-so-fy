export default {
  ...
  video: {
    ...
    apiDocs: {
      ...
      create: {
        title: '创建视频任务',
        description: '文本、首尾帧和参考图都提交到同一接口。首尾帧使用 start_frame_url 与 end_frame_url；参考图使用带连续 order 的 guidances.image_reference，两种图片模式不能同时提交。',
      },
      examples: {
        textToVideo: '文生视频请求',
      ...
      fields: {
        ...
        yes: '是',
        no: '否',
        model: '模型标识，例如 seedance-2.0 或 seedance-2.0-fast。',
        prompt: '场景、动作、镜头和风格描述。',
        resolution: '工作台按模型过滤分辨率；seedance-2.0 和 seedance-2.0-fast 当前均支持 480p、720p、1080p。',
        duration: '视频秒数，只能选择 4 到 15 之间的整数，默认 8 秒。',
        aspectRatio: '画面比例按分辨率过滤；720p 不支持 9:21，其余已开放分辨率支持 16:9、9:16、1:1、4:3、3:4、21:9 和 9:21。',
        ...
        guidances: '高级参考对象；多图放在 image_reference，最多 4 项，不能与首尾帧混用；order 可省略并由最新版 LeoStudio 按顺序补齐。',
      },
      jobs: {
        title: '查询与管理任务',
    ...
    imageInputExclusive: '参考图与首尾帧是两种独立模式，不能同时使用。',
