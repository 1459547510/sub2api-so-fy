  ...
  video: {
    ...
    apiDocs: {
      ...
      fields: {
        ...
        resolution: '480p、720p 或 1080p；默认由服务端模型配置决定。',
        duration: '视频秒数，工作台支持 4 到 15 秒。',
        aspectRatio: '画面比例，例如 16:9、9:16、1:1、4:3、3:4、21:9 或 9:21。',
        ...
        guidances: '高级参考对象；多图放在 image_reference，最多 4 项，不能与首尾帧混用。',
      },
      jobs: {
        title: '查询与管理任务',
