export default {
  ...
  video: {
    ...
    apiDocs: {
      ...
      upload: {
        title: '上传本地参考图',
        description: '先上传本地图片，再把响应中的 image_url 放入单图或多图生成请求。',
        constraints: '表单字段名为 image；支持 PNG、JPEG 和 WebP，单文件最大 10 MiB。返回地址供视频服务内部读取，不应长期保存或公开分发。',
      },
      create: {
        title: '创建视频任务',
        description: '文本、首尾帧和参考图都提交到同一接口。首尾帧使用 start_frame_url 与 end_frame_url；参考图使用带连续 order 的 guidances.image_reference。',
      },
      examples: {
        textToVideo: '文生视频请求',
      ...
      fields: {
        ...
        startFrameUrl: '独立首帧绝对 HTTP(S) 地址，可与尾帧和参考图同时提交。',
        endFrameUrl: '独立尾帧绝对 HTTP(S) 地址，可与首帧和参考图同时提交。',
        guidances: '高级参考对象；多图放在 image_reference，最多 4 项。',
      },
      jobs: {
        title: '查询与管理任务',
