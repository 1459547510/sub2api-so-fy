export default {
  ...
  usage: {
    ...
    tokenIncentive: {
      ...
      claim: '领取奖励',
      claiming: '领取中...',
      claimSuccess: '奖励已发放到余额',
      claimFailed: '领取失败，请稍后重试',
      loadFailed: '加载 Token 激励状态失败',
      disabled: 'Token 激励计划未开启',
      notEligible: '本周 Token 消耗尚未达标',
      alreadyClaimed: '本周奖励已领取',
    },
    resetNow: '现在',
    resetPending: '待刷新',
  ...
  redeem: {
    ...
    balanceAddedTokenIncentive: '余额充值（Token 激励）',
  ...
  video: {
    eyebrow: 'Sub2 视频服务',
    title: '视频生成',
    description: '输入文字或图片生成视频，并在平台内跟踪任务队列。',
    tabs: {
      label: '视频生成页面',
      workbench: '生成工作台',
      apiDocs: 'API 对接文档',
    ...
    pricing: {
      eyebrow: '当前账号可见价格',
      title: '模型计费',
      description: '每个模型使用渠道里管理员配置的单价；分组里的按模型覆盖价优先于分组统一价。',
    ...
    apiDocs: {
      v2: {
        ...
        description: 'V2 统一提供 OpenAI 图片接口和异步视频接口；模型、权限与计费由 API Key 所属分组决定。',
        badge: 'REST API v2',
        tocLabel: 'V2 文档目录',
        nav: {
          quick: '快速开始', compatibility: 'V1 兼容性', discovery: '模型发现', pricing: '模型价格', images: '图片接口', upload: '上传媒体', video: '视频接口', matrix: '逐模型参数', examples: '模型请求示例', jobs: '查询与管理', status: '状态与错误',
        },
        quick: { title: '快速开始', description: '所有接口使用同一个 Sub2API Key。视频创建建议使用异步响应，图片接口保持 OpenAI 请求和响应格式。', baseUrl: 'Base URL', auth: '鉴权', mode: '视频响应模式' },
        compatibility: {
          title: 'V1 兼容性说明', description: 'V2 在 V1 契约之上增加统一图片接口和模型发现，不要求已接入客户修改调用逻辑。',
          pathsTitle: '路径不变', paths: '原有 /v1/videos/generations、上传、任务查询、下载和取消路径继续有效。',
          keysTitle: 'Key 不变', keys: '原有 Bearer API Key 继续使用；只有获得目标分组权限的 Key 才能调用对应模型。',
          modelsTitle: '模型名可扩展', models: '客户端使用 /v1/models 返回的公开模型 ID，其他选择由服务端完成。',
          contractTitle: '统一契约', contract: '自定义视频模型遵守本页的异步任务契约，自定义图片模型遵守 OpenAI Images 契约即可接入。',
        },
        discovery: { title: '模型发现', description: '在启动或刷新配置时读取当前 Key 可用的模型列表。模型列表是权限范围内的动态结果。', details: '只保存并使用 data[].id 作为后续请求的 model 值。不要根据模型 ID 推断实现细节或拼接其他路由。' },
        pricing: { title: '当前模型价格', description: '价格来自当前账号可见的分组和模型目录；管理员修改定价后，刷新页面即可显示新价格。', refresh: '刷新价格', source: '价格以美元显示，并已包含当前分组生效倍率。', updatedAt: '更新于 {time}', loading: '正在加载当前价格...', unavailable: '当前价格暂时不可用，请稍后刷新。', empty: '当前账号没有可用的媒体分组或模型价格。', group: '分组', model: '模型', type: '类型', price: '价格', image: '图片', video: '视频', allImageModels: '全部图片模型', allVideoModels: '全部视频模型', perRequest: '按次', perMillionTokens: '每 100 万 Token', notConfigured: '未配置' },
        images: { title: 'OpenAI 图片接口', description: '图片生成和编辑遵循 OpenAI Images 请求格式。OpenAI 图片模型支持 JSON URL 和 multipart；Leo 图片模型只接受可访问的 HTTP(S) 参考图 URL，不支持 mask 或 multipart。', generations: '文生图。prompt 必填。Leo 图片模型可在同一接口用 image_urls 或 image_url 加参考图。', edits: '图片编辑。OpenAI 模型使用 images[].image_url 和可选 mask；Leo 图片模型会把 images[].image_url 转成 image_urls 并改走 /v1/images/generations，不接受 mask 或 multipart。' },
        imageFields: { model: '模型 ID；可省略使用服务端默认值，建议显式传入 /v1/models 返回的 ID。', prompt: '生成或编辑说明。', n: '生成数量，范围为 1-10。', size: '输出尺寸，例如 1024x1024；以模型支持范围为准。', responseFormat: 'url 或 b64_json；具体可用值按模型能力返回。', quality: '可选质量档位，只有模型支持时才发送。', imageUrls: '参考图绝对 HTTP(S) URL 数组；Leo 图片模型在 /v1/images/generations 使用，也接受单数 image_url。', edits: 'OpenAI 编辑接口使用 images[].image_url 和可选 mask；Leo 图片模型只接受 images[].image_url，服务端会转成 image_urls。file_id 不在统一契约中。' },
        upload: { title: '上传参考媒体', description: '本地媒体先通过上传接口取得 media_url，再把 URL 放入视频请求。', constraints: 'image 支持 PNG、JPEG、WebP；video 使用 MP4/MOV；audio 使用 MP3 或 PCM WAV。文件大小、编码、时长和数量以所选模型限制为准。' },
        ...
        matrix: {
          title: '逐模型参数矩阵', description: '先通过 /v1/models 确认当前 Key 可用的模型，再按下表选择该模型允许的分辨率、时长、画面比例和参考输入。Seedance 2.0 / Fast / Mini 现按 Krea 契约校验，不再使用 Leo 的分辨率拆分和 1080p 12 秒上限。不支持的组合会返回 400 或 422。', model: '模型', resolution: '分辨率', duration: '时长', aspectRatio: '画面比例', references: '参考媒体',
          video: { resolution: '按模型能力', duration: '按模型能力，默认值由服务端决定', aspectRatio: '按模型能力', references: '首尾帧、图片、视频、音频按模型能力启用' },
          image: { resolution: '使用 size 字段，按模型能力', duration: '不适用', aspectRatio: '由 size 或模型默认值决定', references: 'OpenAI 图片模型使用 /v1/images/edits 的 images[] 和可选 mask；Leo 图片模型使用 image_urls，或把 edits 的 images[].image_url 转成 image_urls' },
          seedance20: {
            resolution: '480p、720p、1080p、4k',
            duration: '4-15 秒，默认 5 秒；各分辨率相同',
            aspectRatio: '各分辨率均为 16:9、4:3、1:1、3:4、9:16、21:9',
            promptLimit: 'Krea 未公布固定上限；本网关按 5000 字符校验',
        ...
        models: {
          seedance20: 'Krea Seedance 2.0：支持 480p/720p/1080p/4k，时长 4-15 秒，默认 5 秒；画面比例为 16:9、4:3、1:1、3:4、9:16、21:9。最多 9 张参考图、3 个参考视频和 3 个参考音频。本示例为 4k 文生视频。',
          seedance20Fast: 'Krea Seedance 2.0 Fast：仅 480p/720p，时长 4-15 秒，默认 5 秒；画面比例与标准版相同。最多 9 张参考图、3 个参考视频和 3 个参考音频。',
          seedance20Mini: 'Krea Seedance 2.0 Mini：仅 480p/720p，时长 4-15 秒，默认 5 秒；画面比例与标准版相同，不再限制为 16:9/1:1/9:16。最多 9 张参考图、3 个参考视频和 3 个参考音频。',
        },
        examples: {
        ...
        fields: { field: '字段', type: '类型', required: '必填', description: '说明', yes: '是', no: '否' },
        jobs: { title: '查询与管理任务', description: '任务列表、详情、取消和成品接口都使用创建任务时的同一个 API Key。', list: '列出任务；status 可筛选状态，limit 控制数量。', detail: '读取任务状态和完成结果。', cancel: '取消仍处于 pending 的任务。', content: '下载 completed 任务的视频内容，支持 HTTP Range。' },
        status: { title: '状态与错误', description: '客户端应轮询 status_url，直到任务进入 completed、failed 或 canceled。', lifecycle: '任务状态', pending: '任务已接收，等待执行。', running: '任务正在生成。', settling: '结果正在保存和结算。', completed: '结果已就绪，可下载内容。', terminal: '任务失败或已取消，不会继续执行。' },
        errors: { title: '常见 HTTP 错误', badRequest: 'JSON、必填字段或参数组合无效。', unauthorized: 'API Key 缺失或无效。', payment: '余额不足，任务未创建。', forbidden: 'API Key 所属分组未开放该能力。', notFound: '任务、模型或成品不存在，或不属于当前 API Key。', conflict: '当前任务状态不允许取消或内容尚未就绪。', validation: '参考媒体或模型参数未通过校验。', rateLimit: '请求频率或并发超过当前限制，请退避后重试。', serviceUnavailable: '服务暂时不可用，请按退避策略重试。' },
      },
      version: {
        label: '文档版本',
        v2: 'V2 文档',
      ...
      models: {
        seedance25: '支持 480p/720p，时长 4-30 秒，画面比例支持 16:9、9:16、1:1、4:3、3:4、21:9；最多支持 30 张参考图、10 个参考视频和 10 个参考音频。',
        title: '模型请求示例',
        ...
        grokImagine: '支持 auto、400p、544p、720p、960p，时长 3-15 秒；使用 auto 时画面比例必须为 auto。必须提供一张首帧 URL，不接受其他 guidance。',
        ltx23Pro: '支持 1080p/1440p/2160p，固定 16:9，时长仅可选 6、8、10 秒。支持首尾帧、生成音频和提示词增强，不支持媒体参考。',
        ltx23Fast: '支持 1080p/1440p/2160p，固定 16:9，时长可选 6 至 20 秒的偶数值。支持首尾帧、生成音频和提示词增强，不支持媒体参考。',
        hailuo03: '支持 1440p，时长 5-15 秒，画面比例为 16:9、1:1 或 9:16。最多 5 张参考图或 3 个参考音频，音频总时长最多 15 秒；尾帧必须搭配首帧，首尾帧不能和参考图混用。',
        geminiOmniFlash: '支持 720p，时长 3-10 秒，画面比例为 16:9 或 9:16。最多 5 张参考图；不支持生成音频、首尾帧、参考视频和参考音频。',
        kling21: '支持 1080p，时长只能为 5 或 10 秒，画面比例为 16:9、1:1 或 9:16。必须提供首帧，可选尾帧；支持提示词增强。',
        kling25: '支持 720p/1080p，时长只能为 5 或 10 秒，画面比例为 16:9、1:1 或 9:16。支持首尾帧同时提交和提示词增强。',
        kling25TurboStandard: '支持 720p，时长只能为 5 或 10 秒。必须提供首帧，不支持尾帧；支持提示词增强。',
        kling26: '支持 auto 或 1080p，时长只能为 5 或 10 秒。使用 auto 时画面比例必须为 auto；支持生成音频和 1 张首帧。',
        klingVideoO1: '支持 1080p，时长 3-10 秒。支持首尾帧或参考图；参考视频只能使用已有的 GENERATED 媒体，不能上传本地视频。',
        kling30: '支持 auto、720p、1080p、2160p，时长 3-15 秒。使用 auto 时画面比例必须为 auto；支持首尾帧和生成音频。',
        kling30Turbo: '支持 auto、720p、1080p，时长 3-15 秒。使用 auto 时画面比例必须为 auto；支持首帧和生成音频。',
        klingVideoO3: '支持 720p/1080p/2160p，时长 3-15 秒。首尾帧不能和其他参考混用；使用 GENERATED 视频参考时最多 4 张图且时长最多 10 秒。',
        veo31Generate: '支持 720p/1080p/2160p，时长只能为 4、6 或 8 秒，画面比例为 16:9 或 9:16。支持首尾帧、最多 3 张参考图和生成音频。',
        veo31Fast: '支持 720p/1080p/2160p，时长只能为 4、6 或 8 秒，画面比例为 16:9 或 9:16。支持首尾帧和生成音频，不支持参考图。',
        veo31Lite: '支持 720p/1080p，时长只能为 4、6 或 8 秒，画面比例为 16:9 或 9:16。支持首尾帧和生成音频。',
      },
      matrix: {
        seedance25: {
          resolution: '480p、720p',
          duration: '4-30 秒，默认 8 秒',
          aspectRatio: '16:9、9:16、1:1、4:3、3:4、21:9',
          promptLimit: '5000 字符',
          references: '首帧 1、尾帧 1、参考图 30、参考视频 10、参考音频 10；参考音频总时长最多 30.2 秒',
        },
        title: '逐模型参数矩阵',
        description: '下表是服务端实际校验的参数范围。分辨率、时长和画面比例必须使用同一行允许的组合；参考输入能力也按模型区分。',
        model: '模型',
        resolution: '分辨率',
        duration: '时长 / 默认值',
        aspectRatio: '画面比例',
        ...
        seedance20: {
          ...
          duration: '4-15 秒，默认 8 秒；1080p 最长 12 秒',
          aspectRatio: '480p/1080p：16:9、9:16、1:1、4:3、3:4、21:9、9:21；720p 不含 9:21',
          promptLimit: '5000 字符',
          references: '首帧 1、尾帧 1、参考图 4、参考视频 3、参考音频 1',
        },
        seedance20Fast: {
          resolution: '480p、720p',
          duration: '4-15 秒，默认 8 秒',
          aspectRatio: '480p：全部 7 种 Seedance 比例；720p 不含 9:21',
          promptLimit: '5000 字符',
          references: '首帧 1、尾帧 1、参考图 4、参考视频 3、参考音频 1',
        },
        seedance20Mini: {
          resolution: '480p、720p',
          duration: '4-15 秒，默认 8 秒',
          aspectRatio: '两档均为 16:9、1:1、9:16',
          promptLimit: '5000 字符',
          references: '首帧 1、尾帧 1、参考图 4、参考视频 3、参考音频 1',
        },
        happyHorse: {
          ...
          promptLimit: '2500 字符',
          references: '首帧 1 或参考图 9；不支持尾帧、参考视频、参考音频；支持 prompt_enhance',
        },
        grokImagine: {
          resolution: 'auto、400p、544p、720p、960p',
          duration: '3-15 秒，默认 6 秒',
          aspectRatio: 'auto 只能搭配 auto；400p/720p：16:9、9:16；544p/960p：仅 1:1',
          promptLimit: '5000 字符',
          references: '必须提供且只能提供 1 个首帧；不支持尾帧、参考图、参考视频、参考音频',
        },
        ltx23Pro: {
          resolution: '1080p、1440p、2160p',
          duration: '6、8 或 10 秒，默认 6 秒',
          aspectRatio: '仅 16:9',
          promptLimit: '5000 字符',
          references: '首帧 1、尾帧 1；不支持参考图、参考视频、参考音频；支持生成音频和 prompt_enhance',
        },
        ltx23Fast: {
          resolution: '1080p、1440p、2160p',
          duration: '6、8、10、12、14、16、18 或 20 秒，默认 6 秒',
          aspectRatio: '仅 16:9',
          promptLimit: '5000 字符',
          references: '首帧 1、尾帧 1；不支持参考图、参考视频、参考音频；支持生成音频和 prompt_enhance',
        },
        hailuo03: {
          resolution: '仅 1440p',
          duration: '5-15 秒，默认 5 秒',
          aspectRatio: '16:9、1:1、9:16',
          promptLimit: '2000 字符',
          references: '参考图最多 5 张，或参考音频最多 3 个且总时长 15 秒；首帧 1、尾帧 1；首尾帧不能和参考图混用；不支持参考视频',
        },
        geminiOmniFlash: {
          resolution: '仅 720p',
          duration: '3-10 秒，默认 5 秒',
          aspectRatio: '16:9、9:16',
          promptLimit: '2500 字符',
          references: '参考图最多 5 张；不支持生成音频、首尾帧、参考视频或参考音频',
        },
        kling21: {
          resolution: '仅 1080p',
          duration: '5 或 10 秒，默认 5 秒',
          aspectRatio: '16:9、1:1、9:16',
          promptLimit: '2500 字符',
          references: '必须有首帧，可选尾帧；支持 prompt_enhance',
        },
        kling25: {
          resolution: '720p、1080p',
          duration: '5 或 10 秒，默认 5 秒',
          aspectRatio: '16:9、1:1、9:16',
          promptLimit: '2500 字符',
          references: '首帧 1、尾帧 1；支持 prompt_enhance',
        },
        kling25TurboStandard: {
          ...
          aspectRatio: '16:9、1:1、9:16',
          promptLimit: '2500 字符',
          references: '必须有首帧；不支持尾帧',
        },
        kling26: {
          resolution: 'auto、1080p',
          duration: '5 或 10 秒，默认 5 秒',
          aspectRatio: 'auto 只能搭配 auto；其他情况为 16:9、1:1、9:16',
          promptLimit: '2500 字符',
          references: '首帧最多 1 张；支持生成音频',
        },
        klingVideoO1: {
          resolution: '仅 1080p',
          duration: '3-10 秒，默认 5 秒',
          aspectRatio: '16:9、1:1、9:16',
          promptLimit: '2500 字符',
          references: '支持首尾帧或参考图；参考视频必须是已有 GENERATED 媒体，不能上传本地视频',
        },
        kling30: {
        ...
        klingVideoO3: {
          ...
          aspectRatio: '16:9、1:1、9:16',
          promptLimit: '2500 字符',
          references: '参考图最多 7 张或 1 个 GENERATED 视频；使用视频时最多 4 张图且最多 10 秒；首尾帧不能和其他参考混用',
        },
        veo31Generate: {
          resolution: '720p、1080p、2160p',
          duration: '4、6 或 8 秒，默认 8 秒',
          aspectRatio: '16:9、9:16',
          promptLimit: '9999 字符',
          references: '首帧 1、尾帧 1、参考图最多 3 张；支持生成音频',
        },
        veo31Fast: {
          resolution: '720p、1080p、2160p',
          duration: '4、6 或 8 秒，默认 8 秒',
          aspectRatio: '16:9、9:16',
          promptLimit: '9999 字符',
          references: '首帧 1、尾帧 1；不支持参考图；支持生成音频',
        },
        veo31Lite: {
          resolution: '720p、1080p',
          duration: '4、6 或 8 秒，默认 8 秒',
      ...
      quick: {
        title: '快速开始',
        description: '所有视频接口使用同一个 Sub2API Key。创建任务时必须声明异步响应，服务会立即返回 Sub2API 任务编号。',
        baseUrl: 'Base URL',
        auth: '鉴权',
        mode: '响应模式',
      },
      upload: {
        title: '上传参考媒体',
        description: '先上传本地图片、参考视频或参考音频，再把响应中的 media_url 放入视频任务；参考图模式不能和首尾帧模式混用。',
        constraints: '图片必须是可读取的 PNG、JPEG 或 WebP，单文件最大 10 MiB。参考视频使用 video 字段，必须是可读取的 MP4/MOV 容器，单文件最大 100 MiB；只有模型规格允许 UPLOADED 视频参考时才能使用，页面会先检查本地视频能否解码，但非标准尺寸或编码仍可能在处理阶段被拒绝。参考音频使用 audio 字段，必须包含可读取的 MP3 帧，或 RIFF/WAVE PCM 16/24 位 WAV，单文件最大 15 MiB、时长 2 到 30 秒；数量和总时长按模型限制，Hailuo 03 的音频总时长最多 15 秒，并且要搭配参考图或参考视频。',
      },
      uploadMediaTitle: '上传参考媒体',
      uploadMediaDescription: '上传图片、参考视频或参考音频后，使用返回的 media_url 创建视频任务。',
      uploadMediaConstraints: '图片支持 PNG、JPEG、WebP，单文件不超过 10 MiB；视频必须使用 MP4/MOV 文件名并且是可读取的 ISO Base Media 容器，单文件不超过 100 MiB，只有允许 UPLOADED 视频参考的模型才能使用。公开接口没有承诺统一的视频时长、帧率、编码或尺寸白名单，非标准文件仍可能在处理阶段被拒绝；音频必须包含可读取的 MP3 帧，或 RIFF/WAVE PCM 16/24 位 WAV，单文件不超过 15 MiB，时长必须为 2 到 30 秒，数量和总时长按模型限制，Hailuo 03 总时长最多 15 秒，并且必须搭配参考图或参考视频。',
      uploadMediaFormat: '先用 multipart 的 image、video 或 audio 字段上传，读取响应中的 media_url；再将它放入对应的公开 guidance 对象，并写入 type: "UPLOADED"。只有模型规格明确允许 UPLOADED 视频时才能使用上传的视频；Kling O-1/O-3 的视频参考只接受已有 GENERATED 媒体，不能用本地视频上传替代。',
      createMediaDescription: '文本、首尾帧、参考图片、参考视频和参考音频使用同一个创建接口；首帧和尾帧可以同时提交，但模型声明首尾帧互斥时，不能和参考图或参考视频混用。数量、时长和是否支持生成音频均按模型限制。直接填写媒体 URL 时必须是绝对 HTTP(S) 地址、扩展名或响应类型可识别，并且在排队期间保持可访问。创建 JSON 不接受 data URL、Base64 或 multipart 媒体。',
      create: {
        title: '创建视频任务',
        description: '文本、首尾帧、参考图、参考视频和参考音频都提交到同一接口。本地媒体请使用上传接口返回的 media_url；音频参考必须同时搭配参考图或参考视频。',
      },
      examples: {
        videoReference: '参考视频请求体',
        audioReference: '参考音频请求体',
        happyHorse: 'Happy Horse 请求',
        grok: 'Grok 请求',
        textToVideo: '文生视频请求',
        acceptedResponse: '202 接收响应',
        upload: '上传请求',
        uploadResponse: '上传响应',
        uploadMedia: '上传参考视频和音频',
        singleImage: '单图首帧请求体',
        framePair: '首帧与尾帧请求体',
        multiImage: '多图参考请求体',
        poll: '查询任务并下载成品',
      ...
      fields: {
        ...
        yes: '是',
        no: '否',
        model: '模型标识请从参数矩阵中选择；工作台和网关都会拒绝未知模型或不匹配的模型参数组合。',
        prompt: '描述场景、动作、镜头和风格；最大长度按模型不同，详见参数矩阵。',
        resolution: '工作台按模型过滤分辨率。auto 仅适用于 Grok Imagine 1.5、Kling 2.6、Kling 3.0 和 Kling 3.0 Turbo，并且必须搭配 aspect_ratio: auto。',
        duration: '必须选择模型支持的整数秒数或枚举时长；即使直接调用 API，网关也会拒绝不支持的值。',
        aspectRatio: '画面比例按模型和分辨率过滤；auto 只能在支持 auto 分辨率的模型中与 auto 搭配使用。',
        audio: '是否请求生成音频，默认 false。',
        imageUrl: '单张首帧绝对 HTTP(S) 地址，可使用上传接口返回值。',
        startFrameUrl: '独立首帧绝对 HTTP(S) 地址，可与尾帧同时提交，但不能与参考图混用。',
        endFrameUrl: '独立尾帧绝对 HTTP(S) 地址，可与首帧同时提交，但不能与参考图混用。',
         guidances: '高级参考对象；将上传接口返回的 media_url 放入 image_reference、video_reference_base 或 audio_reference。音频参考必须搭配参考图或参考视频。',
         guidancesPublic: '参考媒体对象；图片使用 image_reference[].image，视频使用 video_reference_base[].video，音频使用 audio_reference[].audio；对象填写上传接口返回的 media_url 和 type: "UPLOADED"。数量和首尾帧互斥规则按模型限制；参考音频必须搭配参考图或参考视频。Kling O-1/O-3 的视频参考只接受已有 GENERATED 媒体，不能通过上传本地视频生成。',
        promptEnhance: 'happy-horse-1.1、kling-2.1、kling-2.5 和 kling-2.5-turbo-standard 支持 AUTO、ON 或 OFF；只有 Happy Horse 禁止 ON 与首帧同时使用。',
      },
      jobs: {
        title: '查询与管理任务',
        description: '列表、详情、取消和成品接口都按创建任务时使用的 API Key 隔离。',
        list: '列出最近任务；status 可筛选状态，limit 控制数量。',
        detail: '读取单个任务及完成结果。',
        cancel: '取消仍处于 pending 的任务。',
        content: '下载 completed 任务的 MP4，支持 HTTP Range。',
      },
      status: {
        title: '状态与错误',
        description: '客户端应轮询 status_url，直到任务进入 completed、failed 或 canceled。',
        lifecycle: '任务状态',
        pending: '任务已接收，等待视频服务开始执行。',
        running: '视频服务正在生成视频。',
        settling: '视频已生成，平台正在校验、保存和结算。',
        completed: '本地 MP4 已就绪，可调用 content 接口下载。',
        terminal: '任务失败或已取消，不会再继续执行。',
      },
      errors: {
        title: '常见 HTTP 错误',
        badRequest: '请求 JSON、必填字段或参数格式无效。',
        unauthorized: 'API Key 缺失或无效。',
        payment: '余额不足，任务未创建。',
        forbidden: 'API Key 所属分组未开放视频生成。',
        notFound: '任务或成品不存在，或不属于当前 API Key。',
        conflict: '任务状态不允许取消或成品尚未就绪。',
        validation: '参考图或 guidance 未通过请求校验。',
        serviceUnavailable: '视频服务暂时不可用或请求失败。',
      },
    },
    settings: '生成设置',
    settingsHint: '当前 Sub2 API Key 决定权限和计费归属。',
    apiKey: 'Sub2 API Key',
    savedApiKey: '已保存 Key',
    customApiKey: '自定义 Key',
    customApiKeyPlaceholder: '输入 Sub2 API Key',
    showApiKey: '显示 API Key',
    hideApiKey: '隐藏 API Key',
    prompt: '提示词',
    promptPlaceholder: '描述场景、动作、镜头和视觉风格。',
    model: '模型',
    resolution: '分辨率',
    aspectRatio: '画面比例',
    duration: '时长（秒）',
    audio: '生成音频',
    audioHint: '请求在成品中生成音频；这与上传参考音频是两种不同用法。',
    imageInput: '参考图片（最多 {count} 张）',
    imageNone: '无',
    imageLocal: '本地文件',
    imageRemote: '图片 URL',
    chooseImage: '选择 PNG、JPEG 或 WebP 图片',
    addImage: '继续添加参考图片',
    replaceImage: '重新选择图片',
    removeImage: '移除图片',
    chooseStartFrame: '选择首帧图片',
    replaceStartFrame: '更换首帧图片',
    removeStartFrame: '移除首帧',
    chooseEndFrame: '选择尾帧图片',
    replaceEndFrame: '更换尾帧图片',
    removeEndFrame: '移除尾帧',
    imageUrl: '参考图片 URL',
    imageUrlPlaceholder: 'https://example.com/reference-1.png\nhttps://example.com/reference-2.png',
    startFrameUrl: '首帧 URL',
    endFrameUrl: '尾帧 URL',
    ...
    invalidImage: '仅支持 PNG、JPEG 和 WebP 图片。',
    imageTooLarge: '单张图片不能超过 10 MiB。',
    tooManyImages: '最多选择 {count} 张参考图片。',
    invalidModelParameters: '当前模型不支持所选分辨率、时长或画面比例，请重新选择。',
    imageInputExclusive: '首帧和尾帧可以同时提交；参考图不能与任一首尾帧同时使用。',
     imageInputConflict: '参考图与首尾帧不能同时使用，请先移除当前图片。',
     videoReference: '参考视频（最多 3 个）',
     videoReferenceHint: '仅支持可读取的 MP4/MOV 容器，单个不超过 100 MiB；每个任务最多 3 个。文件必须能正常解码，公开规范没有统一的视频时长、帧率、编码或尺寸白名单，非标准文件可能在处理阶段被拒绝。',
     chooseVideoReference: '选择 MP4 或 MOV 视频',
     removeVideoReference: '移除参考视频',
     tooManyVideoReferences: '最多选择 3 个参考视频。',
     invalidVideo: '仅支持可读取的 MP4/MOV 容器视频，不能只修改文件扩展名。',
     videoTooLarge: '单个参考视频不能超过 100 MiB。',
     audioReference: '参考音频（最多 1 个）',
     audioReferenceHint: '仅支持包含可读取 MP3 帧的 MP3，或 RIFF/WAVE PCM 16/24 位 WAV；单个不超过 15 MiB，时长 2 到 30 秒。每个任务最多 1 个，且必须搭配参考图或参考视频。',
     chooseAudioReference: '选择 MP3 或 WAV 音频',
     replaceAudioReference: '替换参考音频',
     removeAudioReference: '移除参考音频',
     invalidAudio: '仅支持可读取的 MP3 或 PCM 16/24 位 WAV 音频。',
     audioTooLarge: '参考音频不能超过 15 MiB。',
     audioDuration: '参考音频时长必须在 2 到 30 秒之间。',
     audioNeedsVisualReference: '参考音频必须搭配参考图或参考视频。',
    modelGuidanceUnsupported: '当前模型不支持所提供的某个参考输入或选项。',
    promptEnhance: '提示词增强',
    promptEnhanceAuto: '使用模型默认值（AUTO）',
    noKey: '没有已保存的视频 API Key',
    ...
    previewEmptyHint: '完成的视频会显示在这里，并支持原生播放控件。',
    previewError: '视频加载失败。',
    retryPreview: '重试',
    noJobs: '还没有视频任务',
    noJobsHint: '提交提示词后开始第一个视频任务。',
    download: '下载',
    open: '打开视频',
    cancel: '取消任务',
    status: { pending: '排队中', running: '生成中', settling: '结算中', completed: '已完成', failed: '失败', canceled: '已取消' },
  },
