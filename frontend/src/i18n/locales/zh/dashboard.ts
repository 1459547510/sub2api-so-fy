export default {
  ...
  video: {
    ...
    apiDocs: {
      ...
      quick: {
        title: '快速开始',
        description: '所有视频接口使用同一个 Sub2API Key。创建任务时必须声明异步响应，服务会立即返回平台任务编号。',
        baseUrl: 'Base URL',
        auth: '鉴权',
        mode: '响应模式',
      },
      upload: {
        title: '上传本地图片',
        description: '先上传本地图片，再把响应中的 image_url 放入首尾帧或参考图请求；两种图片模式不能混用。',
      ...
      fields: {
        ...
        endFrameUrl: '独立尾帧绝对 HTTP(S) 地址，可与首帧同时提交，但不能与参考图混用。',
         ...
         guidancesPublic: '参考媒体对象；将上传接口返回的 media_url 放入 image_reference、video_reference_base 或 audio_reference。参考音频必须搭配参考图或参考视频。',
      },
      jobs: {
        title: '查询与管理任务',
      ...
      errors: {
        ...
        upstream: '视频供应商暂时不可用或请求失败。',
      },
      privacy: '公开接口只返回 Sub2API job_id。页面与响应不会展示供应商 API Key、Cookie、账号标识或供应商任务编号。',
    },
    settings: '生成设置',
    ...
    duration: '时长（秒）',
    audio: '生成音频',
    audioHint: '将音频偏好传递给 Leo Studio。',
    imageInput: '参考图片（最多 4 张）',
    imageNone: '无',
    imageLocal: '本地文件',
    imageRemote: '图片 URL',
    ...
    imageInputExclusive: '首帧和尾帧可以同时提交；参考图不能与任一首尾帧同时使用。',
     ...
     videoReferenceHint: '上传 MP4 或 MOV 文件，提交时会放入 video_reference_base 参考对象。',
     chooseVideoReference: '选择 MP4 或 MOV 视频',
     removeVideoReference: '移除参考视频',
     tooManyVideoReferences: '最多选择 3 个参考视频。',
     invalidVideo: '仅支持可读取的 MP4 和 MOV 视频。',
     audioReference: '参考音频（最多 1 个）',
     audioReferenceHint: '上传 MP3 或 PCM 16/24 位 WAV，时长 2 到 30 秒，大小不超过 15 MiB；必须搭配参考图或参考视频。',
     chooseAudioReference: '选择 MP3 或 WAV 音频',
     replaceAudioReference: '替换参考音频',
     removeAudioReference: '移除参考音频',
     invalidAudio: '仅支持 MP3 或 PCM 16/24 位 WAV 音频。',
     audioTooLarge: '参考音频不能超过 15 MiB。',
     audioDuration: '参考音频时长必须在 2 到 30 秒之间。',
     audioNeedsVisualReference: '参考音频必须搭配参考图或参考视频。',
    noKey: '没有已保存的 Leo API Key',
    noKeyHint: '请创建属于 Leo 分组的有效 API Key，或使用自定义 Sub2 API Key。',
    results: '最新结果',
    resultsHint: '活动任务每两秒自动刷新。',
    polling: '正在刷新活动任务',
    queueReady: '队列已就绪',
    previewEmpty: '选择已完成任务预览视频',
    previewEmptyHint: '完成的 Leo 视频会显示在这里，并支持原生播放控件。',
    previewError: '视频加载失败。',
    retryPreview: '重试',
    noJobs: '还没有视频任务',
    noJobsHint: '提交提示词后开始第一个 Leo 视频任务。',
    download: '下载',
    open: '打开视频',
    cancel: '取消任务',
