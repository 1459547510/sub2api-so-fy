export default {
  ...
  admin: {
    ...
    users: {
      ...
      typeTokenIncentive: '余额（Token 激励）',
  ...
  version: {
    ...
    upstreamUpdateAvailable: '原仓库有更新',
    upstreamSyncRequiredHint: '需要先同步源仓库代码，合并到当前二开仓库并发布当前仓库 Release 后，才能执行一键更新。',
    upstreamSyncNoticeTitle: '检测到原仓库新版本，需先同步到当前仓库',
    upstreamForkVersionGap: '原仓库最新：v{upstream}；当前仓库最新：v{fork}。',
    upstreamForkUpdatePolicy: '应用内更新只会安装当前仓库 Release，不会直接下载原仓库包，避免覆盖二开新增或修改内容。',
    forkReleaseReady: '当前仓库 Release 可更新',
    noForkReleaseReadyHint: '当前 fork 还没有包含该上游更新的可用 Release，因此暂不显示一键更新按钮。',
    forkLatestVersion: '当前仓库最新版本',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
