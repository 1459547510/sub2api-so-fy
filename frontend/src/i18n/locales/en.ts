export default {
  ...
  admin: {
    ...
    users: {
      ...
      typeTokenIncentive: 'Balance (Token incentive)',
  ...
  version: {
    ...
    upstreamUpdateAvailable: 'Original repository has updates',
    upstreamSyncRequiredHint: 'Sync upstream source, merge it into this fork, then publish a Release from this repository before using one-click update.',
    upstreamSyncNoticeTitle: 'Upstream has a new version; sync it into this repository first',
    upstreamForkVersionGap: 'Upstream latest: v{upstream}; current repository latest: v{fork}.',
    upstreamForkUpdatePolicy: 'In-app update installs only Releases from this repository and will not download upstream artifacts directly, so fork changes are not overwritten.',
    forkReleaseReady: 'Current repository Release is ready',
    noForkReleaseReadyHint: 'This fork does not yet have a usable Release containing the upstream update, so one-click update is disabled.',
    forkLatestVersion: 'Current repository latest version',
