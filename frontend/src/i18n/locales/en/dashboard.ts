export default {
  ...
  video: {
    ...
    apiDocs: {
      ...
      upload: {
        title: 'Upload a local reference image',
        description: 'Upload local images first, then use the returned image_url in a single-image or multi-image generation request.',
      ...
      create: {
        ...
        description: 'Text, start/end frames, and reference images use the same endpoint. Use start_frame_url and end_frame_url for frames and ordered guidances.image_reference entries for references.',
      },
      examples: {
        ...
        framePair: 'Start frame, end frame, and references body',
      ...
      fields: {
        ...
        startFrameUrl: 'An explicit absolute HTTP(S) start-frame URL. It may be submitted with an end frame and reference images.',
        endFrameUrl: 'An explicit absolute HTTP(S) end-frame URL. It may be submitted with a start frame and reference images.',
        guidances: 'Advanced references. Put up to four images in image_reference.',
      },
      jobs: {
