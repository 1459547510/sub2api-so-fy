    ...
    apiDocs: {
      ...
      fields: {
        ...
        endFrameUrl: 'An explicit absolute HTTP(S) end-frame URL. It may be submitted with a start frame, but not with reference images.',
         ...
         guidancesPublic: 'Reference media objects. Use media_url values returned by the upload endpoint in image_reference, video_reference_base, or audio_reference. Limits are 9 images for happy-horse-1.1, 4 for Seedance, 3 videos, and 1 audio; audio requires an image or video reference.',
