  ...
  video: {
    ...
    apiDocs: {
      ...
      create: {
        ...
        description: 'Text, single-image, and multi-image requests use the same endpoint. Use image_url for one start frame and ordered guidances.image_reference entries for multiple images.',
      },
      examples: {
