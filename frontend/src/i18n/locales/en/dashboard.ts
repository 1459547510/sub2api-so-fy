  ...
  video: {
    ...
    apiDocs: {
      ...
      upload: {
        ...
        description: 'Upload local images first, then use the returned image_url in a frame or reference-image request. The two image modes cannot be combined.',
        constraints: 'The multipart field is named image. PNG, JPEG, and WebP are supported up to 10 MiB per file. The returned address is for internal video-service access and should not be stored long-term or distributed publicly.',
      },
      create: {
        title: 'Create a video job',
        description: 'Text, start/end frames, and reference images use the same endpoint. Use start_frame_url and end_frame_url for frames and ordered guidances.image_reference entries for references. Do not combine the two image modes.',
      },
      examples: {
      ...
      fields: {
        ...
        yes: 'Yes',
        no: 'No',
        model: 'Model ID, such as seedance-2.0 or seedance-2.0-fast.',
        prompt: 'Describe the scene, action, camera, and visual style.',
        resolution: 'The workbench filters resolutions by model. Both seedance-2.0 and seedance-2.0-fast currently support 480p, 720p, and 1080p.',
        duration: 'Choose a whole number of seconds from 4 through 15. The default is 8 seconds.',
        aspectRatio: 'Aspect ratios are filtered by resolution. 720p does not support 9:21; the other enabled resolutions support 16:9, 9:16, 1:1, 4:3, 3:4, 21:9, and 9:21.',
        ...
        guidances: 'Advanced references. Put up to four images in image_reference and do not combine them with frames. The latest LeoStudio fills omitted order values by reference order.',
      },
      jobs: {
    ...
    audioHint: 'Pass the audio preference to Leo Studio.',
    ...
    imageInputExclusive: 'Reference images and start/end frames are separate modes and cannot be used together.',
