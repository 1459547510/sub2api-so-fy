export default {
  ...
  video: {
    ...
    settingsHint: 'Your selected Leo API Key controls access and billing.',
    apiKey: 'Leo API Key',
    prompt: 'Prompt',
    ...
    noKey: 'No Leo API Key is available',
    noKeyHint: 'Create an active API Key in a Leo group with video generation enabled.',
