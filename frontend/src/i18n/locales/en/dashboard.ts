export default {
  ...
  video: {
    ...
    apiDocs: {
      ...
      uploadMediaFormat: 'Reference-video flow: upload with the multipart video field, read media_url from the response, then place it at guidances.video_reference_base[].video.url with type: "UPLOADED". Reference video is available only to Seedance; Happy Horse, Grok, and LTX are rejected during gateway validation.',
      ...
      fields: {
        ...
        aspectRatio: 'Aspect ratios are filtered by model and resolution. LTX 2.3 Pro/Fast support only 16:9; see the model matrix for the other models.',
        ...
        endFrameUrl: 'An explicit absolute HTTP(S) end-frame URL. It may be submitted with a start frame, but not with reference images.',
         ...
         guidancesPublic: 'Reference media objects. Put uploaded media in image_reference[].image, video_reference_base[].video, or audio_reference[].audio; use the returned media_url and type: "UPLOADED". Limits are 9 images for Happy Horse, 4 images/3 videos/1 audio for Seedance, and none for Grok or LTX; audio requires an image or video reference.',
        promptEnhance: 'happy-horse-1.1 and both LTX 2.3 models support AUTO, ON, or OFF. Only Happy Horse forbids ON with a start frame.',
      },
      jobs: {
