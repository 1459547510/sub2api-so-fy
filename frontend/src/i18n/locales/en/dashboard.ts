  ...
  video: {
    ...
    apiDocs: {
      ...
      fields: {
        ...
        resolution: '480p, 720p, or 1080p. The model configuration supplies the default.',
        duration: 'Video duration in seconds. The workbench supports 4 through 15 seconds.',
        aspectRatio: 'For example 16:9, 9:16, 1:1, 4:3, 3:4, 21:9, or 9:21.',
        ...
        guidances: 'Advanced references. Put up to four images in image_reference. Do not combine them with start or end frames.',
      },
      jobs: {
