export default {
  ...
  video: {
    ...
    apiDocs: {
      ...
      quick: {
        title: 'Quick start',
        description: 'All video endpoints use the same Sub2API Key. Creation requests must opt into asynchronous responses and immediately receive a platform job ID.',
        baseUrl: 'Base URL',
        auth: 'Authentication',
        mode: 'Response mode',
      },
      ...
      create: {
        ...
        description: 'Text, frames, image references, video references, and audio references use the same endpoint. Video and audio URLs must be reachable by LeoStudio; audio_reference must be paired with an image_reference or video_reference_base.',
      },
      examples: {
      ...
      fields: {
        ...
        endFrameUrl: 'An explicit absolute HTTP(S) end-frame URL. It may be submitted with a start frame, but not with reference images.',
         ...
         guidancesPublic: 'Reference media objects. Use media_url values returned by the upload endpoint in image_reference, video_reference_base, or audio_reference. Audio references require an image or video reference.',
      },
      jobs: {
      ...
      status: {
        ...
        pending: 'The job was accepted and is waiting for the video provider to start.',
        running: 'The video provider is generating the video.',
      ...
      errors: {
        ...
        upstream: 'The video provider is temporarily unavailable or the request failed.',
      },
      privacy: 'Public endpoints return only the Sub2API job_id. The page and responses never expose provider API keys, Cookies, account identifiers, or provider job IDs.',
    },
    ...
    imageInput: 'Reference images (up to 4)',
    imageNone: 'None',
    ...
    tooManyImages: 'Select no more than 4 reference images.',
    ...
    imageInputExclusive: 'Start and end frames may be submitted together. Reference images cannot be combined with either frame.',
     ...
     videoReferenceHint: 'Upload MP4 or MOV files. The files are sent as video_reference_base guidance.',
     ...
     invalidVideo: 'Only readable MP4 and MOV videos are supported.',
     audioReference: 'Reference audio (up to 1)',
     audioReferenceHint: 'Upload MP3 or PCM 16/24-bit WAV, 2–30 seconds, up to 15 MiB. Pair it with an image or reference video.',
     ...
     invalidAudio: 'Only MP3 or PCM 16/24-bit WAV audio is supported.',
    ...
    noKey: 'No saved Leo API Key is available',
    noKeyHint: 'Create an active API Key in a Leo group or use a custom Sub2 API Key.',
    ...
    previewEmptyHint: 'Completed Leo outputs appear here with native playback controls.',
