export default {
  ...
  version: {
    ...
    forkReleaseReady: 'An update is available in this fork',
    upstreamUpdateAvailable: 'A new upstream release is available',
    upstreamSyncNoticeTitle: 'The upstream release is not synchronized yet',
    upstreamForkVersionGap: 'Upstream latest: v{upstream}; current fork latest: v{fork}.',
    upstreamForkUpdatePolicy: 'Merge upstream and publish a fork release before using in-app update.',
    upstreamSyncRequiredHint: 'In-app update will not install the upstream release directly.',
    noForkReleaseReadyHint: 'There is no directly installable release in this fork yet.',
    branchUpdateAvailable: 'The fork branch has newer commits',
    branchUpdateHint: 'The branch has new commits. Merge or publish them before updating.',
