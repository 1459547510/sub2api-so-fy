    ...
    settings: {
      ...
      features: {
        ...
        videoGeneration: {
          ...
          enabledHint: 'Turning this off only hides the sidebar entry; it does not disable the route or API.',
        },
        siteBillingMode: {
        ...
        tokenIncentive: {
          ...
          rules: 'Reward tiers',
          rulesHint: 'Configure weekly token thresholds in ascending order. Users may claim each reached tier for its configured amount within the week.',
