export default {
    ...
    channels: {
      ...
      emptyModelsInPricing: '{platform} has a pricing entry with no models',
    ...
    riskControl: {
      ...
      cyberPolicyRevokeGroup: 'Remove Exclusive Group on Hit',
      cyberPolicyRevokeGroupHint: 'After a regular user hits cyber_policy, remove the selected OpenAI exclusive-group permission. Administrators are always exempt; other groups are unchanged. Select off to disable.',
      cyberPolicyRevokeGroupDisabled: 'Disable automatic removal',
