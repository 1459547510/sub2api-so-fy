...
const previousCatalog: SeedanceV2DocsCatalog = {
  ...
  zh: {
    matrixDescription: '先通过 /v1/models 确认当前 Key 可用的模型，再按下表选择该模型允许的分辨率、时长、画面比例和参考输入。Seedance 2.0 / Fast 按时长 4-15 秒（默认 5 秒）校验，各分辨率画面比例相同。不支持的组合会返回 400 或 422。',
    seedance20: {
  ...
  en: {
    matrixDescription: 'Read /v1/models first to confirm the models available to the current Key, then choose a supported resolution, duration, aspect ratio, and reference input from the matching row. Seedance 2.0 / Fast accept 4-15 seconds (default 5 seconds) with the same aspect ratios at every listed resolution. Invalid combinations return 400 or 422.',
    seedance20: {
      resolution: '480p, 720p, 1080p, 4k',
...
const currentCatalog: SeedanceV2DocsCatalog = {
  v2MatrixKeys: ['seedance20', 'seedance20Fast', 'seedance25'],
  exampleOverrides: {
  ...
  zh: {
    matrixDescription: '先通过 /v1/models 确认当前 Key 可用的模型，再按下表选择该模型允许的分辨率、时长、画面比例和参考输入。Seedance 2.0 / Fast 时长 4-15 秒（默认 4 秒；1080p 无生成音频最长 15 秒，开启生成音频最长 10 秒）；2.5 仅支持离散时长 4、5、6、8、10、12、15、20、25、30 秒（默认 4 秒；720p 无生成音频最长 30 秒，开启生成音频最长 15 秒）。各分辨率画面比例相同。不支持的组合会返回 400 或 422。',
    seedance20: {
...
/** 与当前 Trioma 能力矩阵同步的 Seedance V2 文档。 */
const triomaCatalog: SeedanceV2DocsCatalog = {
  v2MatrixKeys: ['seedance20', 'seedance20Fast', 'seedance25'],
  exampleOverrides: {
    'seedance-2.0': { description: 'video.apiDocs.v2.models.seedance20', body: seedance20Example(4) },
    'seedance-2.0-fast': { description: 'video.apiDocs.v2.models.seedance20Fast', body: seedance20FastExample(4) },
  ...
  zh: {
    matrixDescription: '先通过 /v1/models 确认当前 Key 可用的模型，再按下表选择该模型允许的分辨率、时长、画面比例和参考输入。Seedance 2.0 / Fast 时长为 4-15 秒（默认 4 秒）；标准版支持 1080p 和 4k，开启生成音频时 1080p 最高 10 秒。2.5 仅支持离散时长 4、5、6、8、10、12、15、20、25、30 秒（默认 4 秒），开启生成音频时最长 15 秒。不支持的组合会返回 400 或 422。',
    seedance20: {
      resolution: '480p、720p、1080p、4k，默认 480p',
      duration: '4-15 秒，默认 4 秒；1080p 无生成音频最长 15 秒，开启生成音频最长 10 秒',
      aspectRatio: '各分辨率均为 16:9、9:16、1:1、4:3、3:4、21:9',
    ...
    seedance20Fast: {
      resolution: '480p、720p，默认 480p',
      duration: '4-15 秒，默认 4 秒；开启生成音频时最长 10 秒',
      aspectRatio: '各分辨率均为 16:9、9:16、1:1、4:3、3:4、21:9',
      promptLimit: promptLimitZh,
      references: '首帧 1、尾帧 1、参考图 9、参考视频 3、参考音频 3；可与首尾帧同时使用',
    },
    seedance25: {
      resolution: '480p、720p，默认 480p',
      duration: '4、5、6、8、10、12、15、20、25、30 秒，默认 4 秒；开启生成音频时最长 15 秒',
      aspectRatio: '各分辨率均为 16:9、9:16、1:1、4:3、3:4、21:9',
      promptLimit: promptLimitZh,
      references: '首帧 1、尾帧 1、参考图 30、参考视频 10、参考音频 10；参考音频总时长最多 30.2 秒，可与首尾帧同时使用',
    },
    models: {
      seedance20: 'Seedance 2.0：支持 480p/720p/1080p/4k，默认 480p；时长 4-15 秒，默认 4 秒；1080p 无生成音频最长 15 秒，开启生成音频最长 10 秒；画面比例为 16:9、9:16、1:1、4:3、3:4、21:9。最多 9 张参考图、3 个参考视频和 3 个参考音频。本示例为 4k 文生视频。',
      seedance20Fast: 'Seedance 2.0 Fast：仅 480p/720p，默认 480p；时长 4-15 秒，默认 4 秒；开启生成音频时最长 10 秒。画面比例为 16:9、9:16、1:1、4:3、3:4、21:9。最多 9 张参考图、3 个参考视频和 3 个参考音频。',
      seedance25: 'Seedance 2.5：仅 480p/720p，默认 480p；时长只能为 4、5、6、8、10、12、15、20、25、30 秒，默认 4 秒；开启生成音频时最长 15 秒。画面比例为 16:9、9:16、1:1、4:3、3:4、21:9。最多 30 张参考图、10 个参考视频和 10 个参考音频，参考音频总时长最多 30.2 秒。',
    },
  },
  en: {
    matrixDescription: 'Read /v1/models first to confirm the models available to the current Key, then choose a supported resolution, duration, aspect ratio, and reference input from the matching row. Seedance 2.0 / Fast accept 4-15 seconds (default 4 seconds); standard supports 1080p and 4k, with generated audio at 1080p limited to 10 seconds. 2.5 accepts only 4, 5, 6, 8, 10, 12, 15, 20, 25, or 30 seconds (default 4 seconds), with generated audio limited to 15 seconds. Invalid combinations return 400 or 422.',
    seedance20: {
      resolution: '480p, 720p, 1080p, 4k, default 480p',
      duration: '4-15s, default 4s; at 1080p, silent clips max 15s and clips with generated audio max 10s',
      aspectRatio: '16:9, 9:16, 1:1, 4:3, 3:4, 21:9 at every resolution',
    ...
    seedance20Fast: {
      resolution: '480p, 720p, default 480p',
      duration: '4-15s, default 4s; generated audio is limited to 10s',
      aspectRatio: '16:9, 9:16, 1:1, 4:3, 3:4, 21:9 at every resolution',
      promptLimit: promptLimitEn,
      references: '1 start frame, 1 end frame, 9 images, 3 videos, 3 audio references; frames may be combined with other references',
    },
    seedance25: {
      resolution: '480p, 720p, default 480p',
      duration: '4, 5, 6, 8, 10, 12, 15, 20, 25, or 30s, default 4s; generated audio is limited to 15s',
      aspectRatio: '16:9, 9:16, 1:1, 4:3, 3:4, 21:9 at every resolution',
      promptLimit: promptLimitEn,
      references: '1 start frame, 1 end frame, 30 images, 10 videos, 10 audio references totaling at most 30.2s; frames may be combined with other references',
    },
    models: {
      seedance20: 'Seedance 2.0 supports 480p/720p/1080p/4k, default 480p, for 4-15 seconds, default 4 seconds, at 16:9, 9:16, 1:1, 4:3, 3:4, or 21:9. At 1080p, silent clips max 15 seconds and clips with generated audio max 10 seconds. Up to 9 image, 3 video, and 3 audio references are supported. This example is 4k text-to-video.',
      seedance20Fast: 'Seedance 2.0 Fast supports 480p/720p, default 480p, for 4-15 seconds, default 4 seconds, with generated audio limited to 10 seconds. It accepts the six Seedance aspect ratios and up to 9 image, 3 video, and 3 audio references.',
      seedance25: 'Seedance 2.5 supports 480p/720p, default 480p, and only 4, 5, 6, 8, 10, 12, 15, 20, 25, or 30 seconds, default 4 seconds. Generated audio is limited to 15 seconds. It accepts the six Seedance aspect ratios and up to 30 image, 10 video, and 10 audio references totaling at most 30.2 seconds.',
    },
  },
}
...
export function applySeedanceV2DocsToDashboard<T>(messages: T, locale: 'zh' | 'en', source: SeedanceV2DocsSource = SEEDANCE_V2_DOCS_SOURCE): T {
  ...
  delete apiDocs.matrix.seedance20Mini
  delete apiDocs.models.seedance20Mini
