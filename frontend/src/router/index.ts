...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/video-generation/api-docs/v1',
    name: 'VideoApiDocsV1',
    component: () => import('@/views/user/VideoApiDocsView.vue'),
    meta: {
      requiresAuth: true,
  ...
  {
    path: '/video-generation/pricing',
    name: 'VideoPricing',
    component: () => import('@/views/user/VideoPricingView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      title: 'Model pricing',
      titleKey: 'video.pricing.title',
      descriptionKey: 'video.pricing.description'
    }
  },
  {
    path: '/usage',
