...
watch(
  ...
  (newPlatform) => {
    ...
    } else if (newPlatform === 'leo' || newPlatform === 'openai_media') {
      apiKeyBaseUrl.value = ''
    } else {
      apiKeyBaseUrl.value =
        (newPlatform === 'openai')
    ...
    if (newPlatform === 'leo' || newPlatform === 'openai_media') {
      ...
      modelMappings.value = [
        ...
        { from: 'bytedance/seedance-2.5', to: 'bytedance/seedance-2.5' },
        { from: 'seedance-2.5', to: 'seedance-2.5' },
