    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M15.75 6.75h3.75A2.25 2.25 0 0121.75 9v6a2.25 2.25 0 01-2.25 2.25h-3.75m0-10.5v10.5m0-10.5H5.25A2.25 2.25 0 003 9v6a2.25 2.25 0 002.25 2.25h10.5m0-10.5l3.75-2.25v15l-3.75-2.25'
        })
      ]
    )
}
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/video-generation', label: t('nav.videoGeneration'), icon: VideoIcon, hideInSimpleMode: true, featureFlag: flagVideoGeneration },
