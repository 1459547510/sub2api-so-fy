...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'leo' | 'openai_media' | 'video' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'opencode_go' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'leo' | 'openai_media' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'opencode_go'
