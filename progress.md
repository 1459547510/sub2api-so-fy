...
## 2026-08-16 - Task: Verify published dynamic pricing release v0.1.177-fy.3
### What was done
- Confirmed the fork branch and release tag are pushed to GitHub.
- Confirmed the public Linux amd64 release asset is downloadable and matches the published checksum.

### Testing
- Remote branch `codex/leo-video-channel`: confirmed at `857f228f62e02f29cffc234305e075afb4b0973c`.
- Remote tag `v0.1.177-fy.3`: confirmed at `532faa4e60c627e7ed9f045b9d8a8bff17a70973`.
- Release asset download: HTTP `200`; `sub2api_0.1.177-fy.3_linux_amd64.tar.gz` size `37,517,341` bytes.
- SHA-256: `f0c58f123ca29ac4d915838e0e1e0f55b44a34ea47e42fe8f737608ce9315790`; matched `checksums.txt`.
- Archive listing: `tar -tzf` contains only `sub2api`.
...
## 2026-08-19 - Task: Release OpenAI-compatible (Sora-format) video entry as v0.1.178-fy.2
### What was done
...
- Prepared annotated tag `v0.1.178-fy.2` from this commit (on top of the upstream v0.1.178 merge released as `v0.1.178-fy.1`).
...
- A first tag for this change was mistakenly pushed as `v0.1.177-fy.11` (the code was already 0.1.178-based); that tag and its GitHub Release were withdrawn in favor of `v0.1.178-fy.2`.
- Roll back source behavior with `git revert --no-commit v0.1.178-fy.1..v0.1.178-fy.2` after reviewing the reversal; the previous deployable source tag is `v0.1.178-fy.1`. To withdraw the binary, remove GitHub Release `v0.1.178-fy.2` and its remote tag. Preserve unrelated `.superpowers/` content.
...
+
## 2026-08-25 - Task: Merge upstream v0.1.182 and prepare FY release v0.1.182-fy.1
### What was done
- Reused the existing validated `v0.1.181` merge whose first parent was the current fork release branch, then merged the official upstream tag `v0.1.182`.
- Resolved the only new code conflict in the OpenAI Images path by retaining the fork's `openAIImagesMaxN = 10` safeguard and adding upstream's verbatim image-prompt instruction; the upstream experimental Responses header and tests remain included.
- Updated the checked-in source version to `0.1.182`. The current worktree's unrelated video documentation WIP remains outside this release and is preserved in a stash.

### Testing
- Backend targeted regression passed: `go test -p 1 ./internal/service ./internal/handler ./internal/repository ./migrations -count=1 -run 'OpenAIImages|OpenAIGatewayServiceForwardImages|BuildOpenAIImagesResponsesRequest|Composite|TokenIncentive|VideoJob|Plugin|QuotaAutoReset|ResponsesLite|ServiceTier|Migration'`.
- Backend full suite passed: `go test -p 1 ./... -count=1`.
- Backend static analysis passed: `go vet ./...`.
- Frontend full suite passed: 256 files and 1868 tests.
- Frontend production build passed with existing Vite dynamic-import/chunk-size warnings.
- Linux amd64 cross-build passed with `CGO_ENABLED=0`, `GOOS=linux`, `GOARCH=amd64`, `-tags embed`, release ldflags, and package inspection. Local archive SHA-256: `6056aaea4f3ea5568cbeadff775b88b654d0bc881f39816294f08aa54a849eb2`; archive contains `sub2api`.
- `git diff --check`, staged whitespace check, and unresolved-conflict check passed.

### Notes
- `backend/cmd/server/VERSION`：同步程序源版本到 `0.1.182`。
- `backend/internal/service/openai_images.go`：保留二开图片数量限制并合入原样提示词常量。
- `.github/workflows/release.yml`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `.gitignore`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `.goreleaser.simple.yaml`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `.goreleaser.yaml`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `Dockerfile`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `Dockerfile.goreleaser`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `Makefile`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `README.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `README_CN.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `README_JA.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `assets/partners/logos/apimart.jpg`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/cmd/server/UPSTREAM_COMMIT`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/cmd/server/main.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/cmd/server/wire.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/cmd/server/wire_gen.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/cmd/server/wire_gen_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/client.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/ent.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/hook/hook.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/intercept/intercept.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/migrate/schema.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/mutation.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/predicate/predicate.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/runtime/runtime.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/schema/user_platform_quota.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/schema/video_job.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/schema/video_job_schema_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/tx.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/videojob.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/videojob/videojob.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/videojob/where.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/videojob_create.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/videojob_delete.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/videojob_query.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/ent/videojob_update.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/go.sum`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/config/config.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/domain/constants.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/domain/constants_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/account_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/account_handler_available_models_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/channel_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/channel_handler_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/content_moderation_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/group_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/payment_handler_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/setting_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/setting_handler_audit.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/setting_handler_update.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/admin/user_platform_quota_admin_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/api_key_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/auth_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/available_channel_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/available_channel_handler_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/composite_platform_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/dto/mappers.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/dto/public_platform_mapper_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/dto/settings.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/endpoint.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/endpoint_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/gateway_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/gemini_v1beta_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/grok_images_split.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/grok_media.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/leo_video.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/leo_video_async.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/leo_video_async_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/leo_video_integration_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/leo_video_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/model_plaza_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/model_plaza_handler_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_chat_completions.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_gateway_cyber_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_gateway_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_images.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_images_controls_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_images_failover_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_images_split.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_responses_failover_cancel_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_video_compat.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/openai_video_compat_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/payment_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/security_audit_helper.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/security_audit_helper_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/setting_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/subscription_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/token_incentive_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/usage_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/usage_record_submit_task_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/user_handler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/user_platform_quotas_handler_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/video_input.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/video_input_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/handler/wire.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/model/error_passthrough_rule.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/model/error_passthrough_rule_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/pkg/ctxkey/ctxkey.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/pkg/proxyurl/parse_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/pkg/xai/oauth_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/account_repo.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/channel_monitor_v2_aggregation.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/channel_monitor_v2_repo_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/cyber_policy_user_marker_cache.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/cyber_policy_user_marker_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/github_release_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/github_release_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/migrations_runner.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/migrations_runner_checksum_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/ops_repo_cyber_policy.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/ops_repo_cyber_policy_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/redeem_code_repo.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/token_incentive_repo.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/token_incentive_repo_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/usage_billing_repo.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/user_repo.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/video_balance_hold_repo_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/video_job_repo.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/video_job_repo_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/repository/wire.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/server/api_contract_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/server/middleware/api_key_auth.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/server/middleware/security_headers.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/server/middleware/security_headers_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/server/routes/composite_platform_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/server/routes/gateway.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/server/routes/gateway_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/server/routes/prompt_audit_route_coverage_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/server/routes/user.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/account.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/account_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/account_test_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/account_test_service_antigravity_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/account_test_service_leo_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/account_usage_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/account_usage_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/admin_account.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/admin_group.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/admin_service_group_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/antigravity_model_mapping_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/antigravity_rate_limit_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/api_key_auth_cache.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/api_key_auth_cache_impl.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/api_key_auth_cache_profit_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/audit_log.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/audit_log_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/batch_image_settlement_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/billing_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/billing_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/channel.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/channel_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/channel_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/channel_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/composite_platform.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/composite_platform_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/composite_route_resolver_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/content_moderation.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/content_moderation_cyber_revoke_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/content_moderation_cyber_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/content_moderation_runtime_cache_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/content_moderation_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/domain_constants.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/error_passthrough_runtime.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/error_passthrough_runtime_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/gateway_anthropic_apikey_passthrough_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/gateway_anthropic_passthrough.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/gateway_streaming_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/gateway_upstream_response.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/gemini_messages_compat_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/gemini_messages_compat_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/grok_media.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_account.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_account_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_image_request.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_image_request_live_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_image_request_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_platform_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_video.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_video_async.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_video_async_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_video_model_specs.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_video_model_specs_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/leo_video_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/media_price_config.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/model_plaza_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/model_pricing_resolver.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/model_pricing_resolver_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_account_runtime_block_fastpath_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_account_scheduler.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_account_scheduler_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_agent_identity_compat_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_alpha_search.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_codex_failover_policy_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_codex_fingerprint_mode_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_codex_identity.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_codex_identity_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_codex_tool_names_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_compact_body_signal_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_cyber_policy_user_filter.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_cyber_policy_user_filter_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_apikey_item_id_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_forward.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_grok_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_passthrough.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_record_usage_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_request_body.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_request_body_reasoning_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_scheduling.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_service_codex_cli_only_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_service_codex_snapshot_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_service_session_isolation_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_upstream_errors.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_gateway_usage.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_images.go`：合并上游图片提示词原样传递指令，同时保留二开 `n` 数量上限。
- `backend/internal/service/openai_images_incomplete_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_images_n_split_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_images_responses.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_images_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_live.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_passthrough_normalization_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_profit_control_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_responses_lite_tools.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_responses_lite_tools_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_responses_tool_schema_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_fallback_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_forwarder_ingress.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_forwarder_ingress_session_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_forwarder_payload.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_forwarder_support.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_forwarder_v2.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_http_bridge.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_http_bridge_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_v2_passthrough_adapter.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/openai_ws_v2_passthrough_lifecycle_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_cyber_policy_ban.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_cyber_policy_ban_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_port.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_repo_mock_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_scheduled_report_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_scheduled_report_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_service_user_error_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_settings.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_settings_models.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ops_user_error_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/payment_order_result_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/plugin_package.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/plugin_package_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/public_vendor.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ratelimit_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ratelimit_service_anthropic_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/ratelimit_service_openai_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/redeem_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/scheduler_snapshot_full_rebuild_lifecycle_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/scheduler_snapshot_group_lifecycle_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/scheduler_snapshot_retirement_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/scheduler_snapshot_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/setting_parse.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/setting_public.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/setting_service_public_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/setting_service_update_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/setting_token_incentive.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/setting_update.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/settings_view.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/token_incentive_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/token_incentive_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/update_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/update_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/upstream_models.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/upstream_models_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/usage_billing.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_billing_resolution.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_billing_resolution_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_input_store.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_input_store_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_job.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_job_billing.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_job_billing_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_job_runtime.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_job_runtime_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_job_service.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_job_service_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_output_store.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/video_output_store_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/service/wire.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/setup/setup.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/web/embed_on.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/internal/web/embed_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/154_token_incentive_claims.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/155_token_incentive_rules.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/156_token_incentive_redeem_history.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/157_token_incentive_tier_claims.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/158_fix_token_incentive_tier_constraints.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/182_video_jobs.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/221_cyber_policy_user_marks.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/222_add_openai_media_platforms.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/227_composite_routes_add_cn_providers.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/227_user_platform_quotas_keep_media_platforms.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/229_composite_routes_keep_media_and_cn_providers.sql`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/composite_routes_cn_providers_migration_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/composite_routes_media_cn_compat_migration_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/user_platform_quota_media_platforms_migration_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `backend/migrations/video_jobs_migration_test.go`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `deploy/Dockerfile`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `deploy/config.example.yaml`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `deploy/docker-compose.local.yml`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `deploy/docker-compose.standalone.yml`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `deploy/docker-compose.yml`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `deploy/docker-deploy.sh`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `deploy/install.sh`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `deploy/sub2api.service`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/ACCOUNT_ERROR_EMAIL_ALERTS.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/BUILD_SECURITY.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/COMPOSITE_GROUPS.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/CONTENT_MODERATION.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/CYBER_POLICY_REVOCATION_BAN.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/FRONTEND_PUBLIC_PAGES.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/GROK_XAI_SUPPORT.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/GROUP_MODEL_PRICING_V176.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/IMAGE_BATCH_REQUESTS.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/LEO_MODEL_SYNC.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/LEO_VIDEO_CHANNEL.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/LEO_VIDEO_MODEL_SPECS.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/OPENAI_CODEX_FINGERPRINT.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/OPENAI_CYBER_POLICY_ACCOUNT_FILTER.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/OPENAI_REASONING_ALIAS_COMPAT.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/TOKEN_INCENTIVE.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/UPDATE_POLICY.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/UPSTREAM_ERROR_URL_REDACTION.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/WEB_API_INTEGRATION_V2_CN.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/superpowers/plans/2026-07-16-leo-video-channel.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/superpowers/plans/2026-07-17-leo-async-video-workbench.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/superpowers/specs/2026-07-14-baota-daily-email-report-design.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/superpowers/specs/2026-07-14-cinematic-a-depth-background-design.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/superpowers/specs/2026-07-16-leo-video-channel-design.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/superpowers/specs/2026-07-17-leo-async-video-workbench-design.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `docs/superpowers/specs/2026-08-16-media-pricing-page-design.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `"docs/\345\257\271\346\216\245\344\272\214\345\274\200\346\226\207\346\241\243.md"`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/package.json`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/pnpm-lock.yaml`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/__tests__/settings.authSourceDefaults.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/__tests__/videoGeneration.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/admin/accounts.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/admin/channels.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/admin/ops.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/admin/riskControl.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/admin/settings.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/admin/system.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/admin/users.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/setup.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/user.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/api/videoGeneration.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/assets/home/telemetry/code.webp`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/assets/home/telemetry/core.webp`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/assets/home/telemetry/meter.webp`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/assets/home/telemetry/route.webp`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/account/CreateAccountModal.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/account/EditAccountModal.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/account/ModelWhitelistSelector.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/account/__tests__/CreateAccountModal.grok.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/account/__tests__/CreateAccountModal.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/account/__tests__/EditAccountModal.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/account/__tests__/ModelWhitelistSelector.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/account/__tests__/credentialsBuilder.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/admin/channel/PricingEntryCard.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/admin/channel/__tests__/PricingEntryCard.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/admin/channel/__tests__/compositeGroups.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/admin/channel/__tests__/types.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/admin/channel/compositeGroups.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/admin/channel/types.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/admin/user/UserBalanceHistoryModal.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/admin/user/UserPlatformQuotaModal.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/admin/user/__tests__/UserPlatformQuotaModal.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/channels/AvailableChannelsTable.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/channels/SupportedModelChip.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/channels/__tests__/AvailableChannelsTable.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/common/GroupBadge.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/common/LocaleSwitcher.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/common/PlatformIcon.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/common/PlatformTypeBadge.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/common/VersionBadge.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/home/TelemetryHome.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/home/__tests__/TelemetryHomePublicSettings.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/layout/AppSidebar.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/layout/TablePageLayout.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/layout/__tests__/AppSidebar.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/user/PlatformUsageBreakdown.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/user/UserErrorDetailModal.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/user/UserErrorRequestsTable.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/user/UserPlatformQuotaCell.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/user/dashboard/UserDashboardStats.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/video/ApiCodeBlock.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/video/EndpointTitle.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/video/SectionHeading.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/video/VideoApiDocsV1Content.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/video/VideoApiDocsV2Content.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/video/VideoSectionTabs.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/video/__tests__/ApiCodeBlock.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/components/video/__tests__/VideoSectionTabs.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/composables/useModelWhitelist.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/constants/__tests__/platforms.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/constants/channel.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/constants/platforms.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/features/channel-monitor-v2/MonitorSettingsPanel.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/features/channel-monitor-v2/RelayPulseMatrix.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/features/prompt-audit/__tests__/integrationSurface.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/admin/accounts.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/admin/audit.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/admin/channels.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/admin/ops.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/admin/overview.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/admin/settings.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/common.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/dashboard.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/landing.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/en/misc.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/admin/accounts.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/admin/audit.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/admin/channels.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/admin/ops.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/admin/overview.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/admin/settings.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/common.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/dashboard.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/landing.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/i18n/locales/zh/misc.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/router/index.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/stores/__tests__/app.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/stores/app.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/types/index.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/utils/__tests__/mediaPricing.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/utils/__tests__/videoApiDocs.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/utils/billingMode.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/utils/featureFlags.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/utils/mediaPricing.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/utils/platformColors.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/utils/seedanceV2DocsCatalog.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/utils/seedanceV2DocsSource.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/utils/videoApiDocs.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/HomeView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/__tests__/HomeTelemetryDefault.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/__tests__/HomeView.compact.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/AuditLogView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/ChannelsView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/GroupsView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/RiskControlView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/SettingsView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/__tests__/SettingsView.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/__tests__/channelPlatformOptions.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/__tests__/groupsImagePricing.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/__tests__/groupsProfitControl.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/groupsImagePricing.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/admin/ops/components/OpsEmailNotificationCard.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/public/ModelsView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/ChannelStatusV2View.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/PaymentResultView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/RedeemView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/UsageView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/VideoApiDocsView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/VideoGenerationView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/VideoPricingView.vue`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/__tests__/PaymentResultView.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/__tests__/UsageView.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/__tests__/VideoApiDocsView.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/__tests__/VideoGenerationView.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `frontend/src/views/user/__tests__/VideoPricingView.spec.ts`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
- `progress.md`：吸收上游 `v0.1.182` 的兼容性修复或对应回归测试。
