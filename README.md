...
- Text/API models: `grok-4.5`, `grok-4.3`, `grok-build-0.1`, `grok-composer-2.5-fast`, `grok-4.20-0309-reasoning`, `grok-4.20-0309-non-reasoning`, and `grok-4.20-multi-agent-0309`
- Text/API aliases: `grok`, `grok-latest`, `grok-4.5-latest`, `grok-build-latest`, `grok-build`, `grok-composer`, `grok-4.20-reasoning`, and `grok-4.20-non-reasoning`
