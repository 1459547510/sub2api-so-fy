...
func TestNormalizeVideoBillingResolutionLeo(t *testing.T) {
	...
	require.Equal(t, VideoBillingResolution1080P, NormalizeLeoVideoBillingResolutionOrDefault("ltxv-2.3-pro", "RESOLUTION_1080"))
	require.Equal(t, VideoBillingResolution1440P, NormalizeLeoVideoBillingResolutionOrDefault("ltxv-2.3-fast", "RESOLUTION_1440"))
...
func TestLeoVideoPricingResolutions(t *testing.T) {
	...
	require.Equal(t, []string{"1080p", "1440p", "2160p"}, LeoVideoPricingResolutions("ltxv-2.3-pro"))
