...
func TestOpenAIGatewayService_Forward_WSv2_OAuthStoreFalseByDefault(t *testing.T) {
	...
	require.Equal(t, isolateOpenAIAccountSessionID(account, 0, "sess-oauth-1"), captureDialer.lastHeaders.Get("session_id"))
	require.Equal(t, isolateOpenAIAccountSessionID(account, 0, "conv-oauth-1"), captureDialer.lastHeaders.Get("conversation_id"))
}
...
func TestOpenAIGatewayService_Forward_WSv2_HeaderSessionFallbackFromPromptCacheKey(t *testing.T) {
	...
	require.Equal(t, isolateOpenAIAccountSessionID(account, 0, "pcache_123"), captureDialer.lastHeaders.Get("session_id"))
