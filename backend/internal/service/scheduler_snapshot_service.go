...
func schedulerSnapshotPlatforms() [7]string {
	return [7]string{PlatformAnthropic, PlatformGemini, PlatformOpenAI, PlatformAntigravity, PlatformGrok, PlatformLeo, PlatformOpenAIMedia}
}
...
func schedulerCanonicalBuckets(groupID int64) []SchedulerBucket {
	buckets := make([]SchedulerBucket, 0, 15)
	for _, platform := range schedulerSnapshotPlatforms() {
