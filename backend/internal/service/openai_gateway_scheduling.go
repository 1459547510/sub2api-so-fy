...
// NormalizeOpenAICompatiblePlatform 保留 grok、媒体平台与国产 OpenAI 兼容供应商（kimi/zhipu/
...
func NormalizeOpenAICompatiblePlatform(platform string) string {
	switch platform {
	case PlatformGrok, PlatformLeo, PlatformOpenAIMedia, PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformMiniMax, PlatformOpenCodeGo:
		return platform
	default:
...
func (s *OpenAIGatewayService) listSchedulableAccounts(ctx context.Context, groupID *int64, platform string) ([]Account, error) {
	...
	if s.schedulerSnapshot != nil {
		...
		return s.filterCyberPolicyUserAccounts(ctx, accounts), nil
	}
...
func (s *OpenAIGatewayService) recheckSelectedOpenAIAccountFromDBBeforeProfit(ctx context.Context, account *Account, groupID *int64, platform string, requestedModel string, requireCompact bool, requiredCapability OpenAIEndpointCapability) *Account {
	...
	if s.shouldSkipCyberPolicyUserAccount(ctx, latest) {
		return nil
	}
	return latest
}
