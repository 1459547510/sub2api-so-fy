...
type OpenAIForwardResult struct {
	...
	// VideoResult is the raw successful video-generation body. Handlers use it
	// to persist a workbench log row; it is not written back to the client.
	VideoResult json.RawMessage
