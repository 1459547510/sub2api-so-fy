...
func (h *GatewayHandler) Models(c *gin.Context) {
	...
	if service.IsMediaPlatform(platform) {
		writeModelsList(c, platform, service.LeoDefaultVideoModelIDs)
		return
	}
...
func (h *GatewayHandler) compositeAvailableModels(ctx context.Context, groupID *int64) []string {
	...
	for _, platform := range []string{service.PlatformAnthropic, service.PlatformGemini, service.PlatformOpenAI, service.PlatformAntigravity, service.PlatformGrok, service.PlatformLeo, service.PlatformOpenAIMedia, service.PlatformKimi, service.PlatformZhipu, service.PlatformDeepseek, service.PlatformMiniMax} {
...
func defaultModelIDsForPlatform(platform string) []string {
	...
	case service.PlatformLeo, service.PlatformOpenAIMedia:
		return append([]string(nil), service.LeoDefaultVideoModelIDs...)
	case service.PlatformComposite:
		ids := make([]string, 0)
		seen := make(map[string]struct{})
		for _, concretePlatform := range []string{service.PlatformAnthropic, service.PlatformGemini, service.PlatformOpenAI, service.PlatformAntigravity, service.PlatformGrok, service.PlatformLeo, service.PlatformOpenAIMedia, service.PlatformKimi, service.PlatformZhipu, service.PlatformDeepseek, service.PlatformMiniMax} {
