...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	videoJobBillingService := service.ProvideVideoJobBillingService(usageBillingRepository, openAIGatewayService, apiKeyRepository, userRepository, accountRepository, userSubscriptionRepository)
	videoJobService := service.NewVideoJobService(videoJobRepository, openAIGatewayService, openAIGatewayService, videoJobBillingService)
	videoInputHandler := handler.ProvideVideoInputHandler(configConfig)
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, configConfig, coordinator, videoJobService, videoInputHandler)
	...
	tokenIncentiveRepository := repository.NewTokenIncentiveRepository(db)
	tokenIncentiveService := service.NewTokenIncentiveService(tokenIncentiveRepository, settingService, apiKeyAuthCacheInvalidator, billingCache)
	tokenIncentiveHandler := handler.NewTokenIncentiveHandler(tokenIncentiveService)
